...
HD_PWD='C:/Users/user/Desktop/Proiect SCID Final/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_fade.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm_fade.tcl -notrace
