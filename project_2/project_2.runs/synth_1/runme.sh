...
HD_PWD='C:/Users/user/Desktop/Proiect SCID Final/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_fade.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_fade.tcl
